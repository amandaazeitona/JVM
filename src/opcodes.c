...
const char* decode_opcode_newarraytype(uint8_t type)
{
    const char* typeName[] = {
        "boolean",
        "char",
    ...
    if (type >= 4 && type <= 11)
        return typeName[type - 4];

    return "unknown type";
}

const char* get_opcode_mnemonic(uint8_t given_opcode)
{
    const char* mnemonics[] = {
        ...
        "ifnull", "ifnonnull", "goto_w", "jsr_w", "breakpoint", NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "impdep1", "impdep2"
    };

    return mnemonics[given_opcode] ? mnemonics[given_opcode] : "- unknown opcode -";
}
